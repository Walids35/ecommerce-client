  ...
  return (
    <>
      <div className="flex gap-10 pt-10 w-full p-5 max-w-7xl mx-auto">
        <div className="hidden md:block max-w-[250px] w-full p-4 border bg-gray-100 border-blue rounded-lg">
          <div
              ...
              return (
                <>
                  ...
                  <div className="flex flex-col" key={index}>
                    <div className="font-medium text-gray-700">{property.name}</div>
                    <div>
                          ...
                          <>
                            <div key={index}>
                              <input
                                ...
                                value={value}
                                onChange={(event) => {
                                  handleCheckboxChange(event, property, value);
                                }}
                              />
                              <label
            ...
            <>
              ...
              <div className="text-sm md:text-base border items-center border-black px-2 py-1 w-full mt-3 flex justify-between">
                <p className="hidden md:block">
                  Display 1-8 of {totalProducts} products
                </p>
                ...
                <div className="flex items-center">
                  ...
                  <select
                    ...
                    className="bg-blue text-white px-2 rounded-full mx-2 py-1"
                    name="sort"
                    id="sort"
                  >
